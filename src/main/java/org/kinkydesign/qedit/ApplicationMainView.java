 ...
 */
public class ApplicationMainView extends FrameView {

    public ApplicationMainView(SingleFrameApplication app) {
        super(app);
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = QEditApplication.getApplication().getMainFrame();
            aboutBox = new QEditAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        QEditApplication.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(org.kinkydesign.qedit.QEditApplication.class).getContext().getResourceMap(ApplicationMainView.class);
