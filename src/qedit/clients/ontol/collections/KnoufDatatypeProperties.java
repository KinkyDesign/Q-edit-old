...
import qedit.clients.ontol.OTDatatypeProperty;
import qedit.clients.ontol.YaqpException;
import qedit.clients.ontol.impl.OTDatatypePropertyImpl;
...
public class KnoufDatatypeProperties {
    ...
    public static OTDatatypeProperty forName(String name) throws YaqpException {
        initMethodCache();
        try {
            Method method = ms_methodCache.get(name);
            if (method == null) {
                throw new YaqpException(Cause.KnoufDatatypePropertyNotFound, "The property '"
